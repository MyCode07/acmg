...
?>
<div class="cart-calculate-area cart-total width-397 cart_totals <?php echo (WC()->customer->has_calculated_shipping()) ? 'calculated_shipping' : ''; ?>">
    ...
    <div class="cart-total__total cart-total__price order-total" data-title="<?php esc_attr_e('Total', 'woocommerce'); ?>"><?php wc_cart_totals_order_total_html(); ?></div>
